...
CivilopediaCategory[CategoryGameConcepts].PopulateList = function()
	...
	sortedList[CategoryGameConcepts][1] = {}; 
	local tableid = 1;
	
	-- for each concept
	for thisConcept in GameInfo.Concepts() do
		if thisConcept.CivilopediaHeaderType == "HEADER_CITIES" then
			...
			sortedList[CategoryGameConcepts][1][tableid] = article;
			tableid = tableid + 1;
	...
	sortedList[CategoryGameConcepts][2] = {}; 
	local tableid = 1;
	for thisConcept in GameInfo.Concepts() do
		if thisConcept.CivilopediaHeaderType == "HEADER_COMBAT" then
			-- add an article to the list (localized name, unit tag, etc.)
			local article = {};
			local name = Locale.ConvertTextKey( thisConcept.Description )
			article.entryName = name;
			...
			sortedList[CategoryGameConcepts][2][tableid] = article;
			tableid = tableid + 1;
	...
	sortedList[CategoryGameConcepts][3] = {}; 
	local tableid = 1;
	for thisConcept in GameInfo.Concepts() do
		if thisConcept.CivilopediaHeaderType == "HEADER_TERRAIN" then
			-- add an article to the list (localized name, unit tag, etc.)
			local article = {};
			local name = Locale.ConvertTextKey( thisConcept.Description )
			article.entryName = name;
			...
			sortedList[CategoryGameConcepts][3][tableid] = article;
			tableid = tableid + 1;
	...
	sortedList[CategoryGameConcepts][4] = {}; 
	local tableid = 1;
	for thisConcept in GameInfo.Concepts() do
		if thisConcept.CivilopediaHeaderType == "HEADER_RESOURCES" then
			-- add an article to the list (localized name, unit tag, etc.)
			local article = {};
			local name = Locale.ConvertTextKey( thisConcept.Description )
			article.entryName = name;
			...
			sortedList[CategoryGameConcepts][4][tableid] = article;
			tableid = tableid + 1;
	...
	sortedList[CategoryGameConcepts][5] = {}; 
	local tableid = 1;
	for thisConcept in GameInfo.Concepts() do
		if thisConcept.CivilopediaHeaderType == "HEADER_IMPROVEMENTS" then
			-- add an article to the list (localized name, unit tag, etc.)
			local article = {};
			local name = Locale.ConvertTextKey( thisConcept.Description )
			article.entryName = name;
			...
			sortedList[CategoryGameConcepts][5][tableid] = article;
			tableid = tableid + 1;
	...
	sortedList[CategoryGameConcepts][6] = {}; 
	local tableid = 1;
	for thisConcept in GameInfo.Concepts() do
		if thisConcept.CivilopediaHeaderType == "HEADER_CITYGROWTH" then
			-- add an article to the list (localized name, unit tag, etc.)
			local article = {};
			local name = Locale.ConvertTextKey( thisConcept.Description )
			article.entryName = name;
			...
			sortedList[CategoryGameConcepts][6][tableid] = article;
			tableid = tableid + 1;
	...
	sortedList[CategoryGameConcepts][7] = {}; 
	local tableid = 1;
	for thisConcept in GameInfo.Concepts() do
		if thisConcept.CivilopediaHeaderType == "HEADER_TECHNOLOGY" then
			-- add an article to the list (localized name, unit tag, etc.)
			local article = {};
			local name = Locale.ConvertTextKey( thisConcept.Description )
			article.entryName = name;
			...
			sortedList[CategoryGameConcepts][7][tableid] = article;
			tableid = tableid + 1;
	...
	sortedList[CategoryGameConcepts][8] = {}; 
	local tableid = 1;
	for thisConcept in GameInfo.Concepts() do
		if thisConcept.CivilopediaHeaderType == "HEADER_CULTURE" then
			-- add an article to the list (localized name, unit tag, etc.)
			local article = {};
			local name = Locale.ConvertTextKey( thisConcept.Description )
			article.entryName = name;
			...
			sortedList[CategoryGameConcepts][8][tableid] = article;
			tableid = tableid + 1;
	...
	sortedList[CategoryGameConcepts][9] = {}; 
	local tableid = 1;
	for thisConcept in GameInfo.Concepts() do
		if thisConcept.CivilopediaHeaderType == "HEADER_DIPLOMACY" then
			-- add an article to the list (localized name, unit tag, etc.)
			local article = {};
			local name = Locale.ConvertTextKey( thisConcept.Description )
			article.entryName = name;
			...
			sortedList[CategoryGameConcepts][9][tableid] = article;
			tableid = tableid + 1;
	...
	sortedList[CategoryGameConcepts][10] = {}; 
	local tableid = 1;
	for thisConcept in GameInfo.Concepts() do
		if thisConcept.CivilopediaHeaderType == "HEADER_HAPPINESS" then
			-- add an article to the list (localized name, unit tag, etc.)
			local article = {};
			local name = Locale.ConvertTextKey( thisConcept.Description )
			article.entryName = name;
			...
			sortedList[CategoryGameConcepts][10][tableid] = article;
			tableid = tableid + 1;
	...
	sortedList[CategoryGameConcepts][11] = {}; 
	local tableid = 1;
	for thisConcept in GameInfo.Concepts() do
		if thisConcept.CivilopediaHeaderType == "HEADER_FOW" then
			-- add an article to the list (localized name, unit tag, etc.)
			local article = {};
			local name = Locale.ConvertTextKey( thisConcept.Description )
			article.entryName = name;
			...
			sortedList[CategoryGameConcepts][11][tableid] = article;
			tableid = tableid + 1;
	...
	sortedList[CategoryGameConcepts][12] = {}; 
	local tableid = 1;
	for thisConcept in GameInfo.Concepts() do
		if thisConcept.CivilopediaHeaderType == "HEADER_POLICIES" then
			-- add an article to the list (localized name, unit tag, etc.)
			local article = {};
			local name = Locale.ConvertTextKey( thisConcept.Description )
			article.entryName = name;
			...
			sortedList[CategoryGameConcepts][12][tableid] = article;
			tableid = tableid + 1;
	...
	sortedList[CategoryGameConcepts][13] = {}; 
	local tableid = 1;
	for thisConcept in GameInfo.Concepts() do
		if thisConcept.CivilopediaHeaderType == "HEADER_GOLD" then
			-- add an article to the list (localized name, unit tag, etc.)
			local article = {};
			local name = Locale.ConvertTextKey( thisConcept.Description )
			article.entryName = name;
			...
			sortedList[CategoryGameConcepts][13][tableid] = article;
			tableid = tableid + 1;
	...
	sortedList[CategoryGameConcepts][14] = {}; 
	local tableid = 1;
	for thisConcept in GameInfo.Concepts() do
		if thisConcept.CivilopediaHeaderType == "HEADER_ADVISORS" then
			-- add an article to the list (localized name, unit tag, etc.)
			local article = {};
			local name = Locale.ConvertTextKey( thisConcept.Description )
			article.entryName = name;
			...
			sortedList[CategoryGameConcepts][14][tableid] = article;
			tableid = tableid + 1;
	...
	sortedList[CategoryGameConcepts][15] = {}; 
	local tableid = 1;
	for thisConcept in GameInfo.Concepts() do
		if thisConcept.CivilopediaHeaderType == "HEADER_PEOPLE" then
			-- add an article to the list (localized name, unit tag, etc.)
			local article = {};
			local name = Locale.ConvertTextKey( thisConcept.Description )
			article.entryName = name;
			...
			sortedList[CategoryGameConcepts][15][tableid] = article;
			tableid = tableid + 1;
	...
	sortedList[CategoryGameConcepts][21] = {}; 
	local tableid = 1;
	for thisConcept in GameInfo.Concepts() do
		if thisConcept.CivilopediaHeaderType == "HEADER_VICTORY" then
			-- add an article to the list (localized name, unit tag, etc.)
			local article = {};
			local name = Locale.ConvertTextKey( thisConcept.Description )
			article.entryName = name;
			...
			sortedList[CategoryGameConcepts][21][tableid] = article;
			tableid = tableid + 1;
	...
	--table.sort(sortedList[CategoryGameConcepts][1], function(a, b) return a.entryName < b.entryName end)
	
	sortedList[CategoryGameConcepts][16] = {}; 
	local tableid = 1;
	for thisConcept in GameInfo.Concepts() do
		if thisConcept.CivilopediaHeaderType == "HEADER_CITYSTATE" then
			-- add an article to the list (localized name, unit tag, etc.)
			local article = {};
			local name = Locale.ConvertTextKey( thisConcept.Description )
			article.entryName = name;
			...
			sortedList[CategoryGameConcepts][16][tableid] = article;
			tableid = tableid + 1;
	...
	sortedList[CategoryGameConcepts][17] = {}; 
	local tableid = 1;
	for thisConcept in GameInfo.Concepts() do
		if thisConcept.CivilopediaHeaderType == "HEADER_MOVEMENT" then
			-- add an article to the list (localized name, unit tag, etc.)
			local article = {};
			local name = Locale.ConvertTextKey( thisConcept.Description )
			article.entryName = name;
			...
			sortedList[CategoryGameConcepts][17][tableid] = article;
			tableid = tableid + 1;
	...
	sortedList[CategoryGameConcepts][18] = {}; 
	local tableid = 1;
	for thisConcept in GameInfo.Concepts() do
		if thisConcept.CivilopediaHeaderType == "HEADER_AIRCOMBAT" then
			-- add an article to the list (localized name, unit tag, etc.)
			local article = {};
			local name = Locale.ConvertTextKey( thisConcept.Description )
			article.entryName = name;
			...
			sortedList[CategoryGameConcepts][18][tableid] = article;
			tableid = tableid + 1;
	...
	sortedList[CategoryGameConcepts][19] = {}; 
	local tableid = 1;
	for thisConcept in GameInfo.Concepts() do
		if thisConcept.CivilopediaHeaderType == "HEADER_RUBARB" then
			-- add an article to the list (localized name, unit tag, etc.)
			local article = {};
			local name = Locale.ConvertTextKey( thisConcept.Description )
			article.entryName = name;
			...
			sortedList[CategoryGameConcepts][19][tableid] = article;
			tableid = tableid + 1;
	...
	sortedList[CategoryGameConcepts][20] = {}; 
	local tableid = 1;
	for thisConcept in GameInfo.Concepts() do
		if thisConcept.CivilopediaHeaderType == "HEADER_UNITS" then
			-- add an article to the list (localized name, unit tag, etc.)
			local article = {};
			local name = Locale.ConvertTextKey( thisConcept.Description )
			article.entryName = name;
			...
			sortedList[CategoryGameConcepts][20][tableid] = article;
			tableid = tableid + 1;
...
CivilopediaCategory[CategoryCityStates].PopulateList = function()
	...
	for trait in GameInfo.MinorCivTraits() do
		...
		-- for each pCity state that has this trait
...
CivilopediaCategory[CategoryTech].SelectArticle = function( techID, shouldAddToList )
	...
	if techID ~= -1 then
		...
		if thisTech.OpenBordersTradingAllowed and (thisTech.Type ~= "TECH_WRITING") then
			if numAbilities > 0 then
				 abilitiesString = abilitiesString .. "[NEWLINE]";
			end
...
function SelectBuildingOrWonderArticle( buildingID )
	if buildingID ~= -1 then
		...
		for row in GameInfo.Building_ClassesNeededInCity( condition ) do
			local prereqCondition = "BuildingClass = '" .. row.BuildingClassType .. "'";
			for thisBuildingInfo in GameInfo.Buildings( prereqCondition ) do
				...
				for thisOverride in GameInfo.Civilization_UnitClassOverrides( condition ) do
					...
					if thisUnitInfo then
						...
						if thisUnitInstance then
							...
							UpdateSmallButton( buttonAdded, thisUnitInstance.UniqueUnitImage, thisUnitInstance.UniqueUnitButton, textureSheet, textureOffset, CategoryUnits, Locale.ConvertTextKey( thisUnitInfo.Description ), thisUnitInfo.ID );
							buttonAdded = buttonAdded + 1;
						end
					end
				end
		...
		if terrainId ~= -1 then
			...
			if thisTerrain then
				...
				if (thisTerrain.Civilopedia) then
					UpdateTextBlock( Locale.ConvertTextKey( thisTerrain.Civilopedia ), Controls.HistoryLabel, Controls.HistoryInnerFrame, Controls.HistoryFrame );
				end
...
CivilopediaCategory[CategoryGameConcepts].DisplayList = function( selectedSection, dummy )
	...
	for section = 1,21,1 do
		local thisHeaderInstance = g_ListHeadingManager:GetInstance();
		if thisHeaderInstance then
			sortedList[CategoryGameConcepts][section].headingOpen = true; -- ain't lua great
			sortOrder = sortOrder + 1;
			local textString = "TXT_KEY_GAME_CONCEPT_SECTION_"..tostring( section );
			local localizedLabel = "[ICON_MINUS] "..Locale.ConvertTextKey( textString );
			thisHeaderInstance.ListHeadingLabel:SetText( localizedLabel );
