...
function( wParam, lParam )
    ...
    if ( wParam == Keys.VK_OEM_3 and UI:DebugFlag() and not PreGame.IsMultiplayerGame() and not PreGame.IsHotSeatGame()) then -- ~
...
function KillPopupText( control )
    ...
    local instance = g_InstanceMap[ tostring( control ) ];
