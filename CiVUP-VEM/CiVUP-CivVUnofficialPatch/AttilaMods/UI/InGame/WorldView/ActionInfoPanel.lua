...
function OnEndTurnClicked()
	...
	if (blockingType == EndTurnBlockingTypes.ENDTURN_BLOCKING_PRODUCTION
...
--		or blockingType == EndTurnBlockingTypes.ENDTURN_BLOCKING_FREE_TECH
		or blockingType == EndTurnBlockingTypes.ENDTURN_BLOCKING_POLICY
...
--		or blockingType == EndTurnBlockingTypes.ENDTURN_BLOCKING_MINOR_QUEST
	...
	elseif blockingType == EndTurnBlockingTypes.ENDTURN_BLOCKING_MINOR_QUEST then
		UI.RemoveNotification( blockingNotificationIndex );
--AttilaMod+
--Open tech tree when Next Turn is blocked by Research or Free Tech
